"""base_model created at and updated

Revision ID: 12992dfbf146
Revises: 8df4fa2abe88
Create Date: 2025-11-11 11:10:18.491485
...
revision: str = '12992dfbf146'
down_revision: Union[str, Sequence[str], None] = '8df4fa2abe88'
...
def upgrade() -> None:
    ...
    sa.Column('token_hash', sa.BigInteger(), nullable=True),
    sa.Column('avatar_asset_id', sa.BigInteger(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['avatar_asset_id'], ['asset.id'], ),
    sa.PrimaryKeyConstraint('id'),
